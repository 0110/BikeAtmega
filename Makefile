...
AVRDUDE_WRITE_FLASH = -U flash:w:$(TARGET).hex -P $(AVRDUDE_PORT)
#AVRDUDE_WRITE_EEPROM = -U eeprom:w:$(TARGET).eep
# Make sure to select the right fuse settings! USe
...
AVRDUDE_READ_FUSES = -U hfuse:r:high.hex:i -U lfuse:r:low.hex:i
